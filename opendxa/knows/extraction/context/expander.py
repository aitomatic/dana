...
"""
    ...
    def expand_context(self, knowledge_point: KnowledgePoint) -> list[ContextExpansion]:
        ...
        try:
            ...
            request = BaseRequest(messages=[{"role": "user", "content": prompt}], model="gpt-4", temperature=0.3, max_tokens=1500)
    ...
    def validate_context(self, knowledge_point: KnowledgePoint) -> ContextValidation:
        ...
        try:
            ...
            request = BaseRequest(messages=[{"role": "user", "content": prompt}], model="gpt-4", temperature=0.2, max_tokens=1000)
