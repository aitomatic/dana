...
class BaseA2AClient(A2AClient):
    ...
    def agent_card(self):
        if (
            ...
            or datetime.now(timezone.utc) - self._last_refresh > self._refresh_interval
        ):
    ...
    def get_json_agent_card(self):
        ...
        skills = [{"name": skill.name, "description": skill.description, "examples": skill.examples} 
