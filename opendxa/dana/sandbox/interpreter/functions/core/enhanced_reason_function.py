"""
POET-Enhanced reason() Function for Semantic Function Dispatch

This module provides a context-aware version of the reason() function that automatically
optimizes prompts based on expected return types and applies semantic coercion.
