...
class SemanticCoercer(Loggable):
    ...
    def _build_boolean_patterns(self) -> dict[str, bool]:
        ...
        return {
            ...
            "yeah": True, "nah": False,
            "yep": True, "nope": False,
            "sure": True, "never": False,
            "absolutely": True, "definitely not": False,
            "of course": True, "no way": False,
            "certainly": True, "not really": False,
            "indeed": True, "hardly": False,
            
            # Numeric zero patterns (CRITICAL FIX)
            "0": False, "0.0": False, "0.00": False,
            "zero": False, "none": False, "null": False,
            "empty": False, "blank": False,
            
            # Positive indicators
            "1": True, "positive": True, "good": True,
            "ok": True, "okay": True, "fine": True,
