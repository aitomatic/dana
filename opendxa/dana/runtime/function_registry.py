...
class FunctionRegistry:
    ...
    def __init__(self):
        ...
        self._functions: Dict[str, Tuple[FunctionImpl, Optional[Dict[str, Any]]]] = {}
...
def _log_function(context: RuntimeContext, args: Dict[str, Any]) -> None:
    ...
    # Get the interpreter log method from the context
    # This is a bit of a hack, but allows us to use the interpreter's log formatting
    log_level = context.get("execution.log_level")
    # Just print for now - in a real implementation, we'd use the interpreter's log method
...
def _register_standard_functions() -> None:
    ...
    register_function("log", _log_function, {
