"""
LLM Tool Call Manager for OpenDXA.
...
class LLMToolCallManager(Loggable):
    ...
    def get_openai_functions(self, resources: dict[str, BaseResource]) -> list[OpenAIFunctionCall]:
    ...
    async def call_tools_legacy(self, tool_calls: list[dict[str, Any]], available_resources: list[BaseResource]) -> list[BaseResponse]:
