"""
OpenDXA AgentRuntime - Runtime for executing agent plans and managing execution flow

Copyright © 2025 Aitomatic, Inc.
MIT License

This module provides the AgentRuntime class for managing agent execution in OpenDXA.
