...
def test_basic_functionality():
    ...
    result = basic_hvac_control(current_temp=70.0, target_temp=72.0, outdoor_temp=65.0, occupancy=True)
    ...
    result = smart_hvac_control(current_temp=70.0, target_temp=72.0, outdoor_temp=65.0, occupancy=True)
...
def test_room_simulation():
    ...
    heating_command = HVACCommand(heating_output=50, cooling_output=0, fan_speed=30, mode="heating")
...
def test_energy_calculations():
    ...
    # Test comfort score
    comfort = calculate_comfort_score(current_temp=72.5, target_temp=72.0, temp_history=[71.8, 72.0, 72.2, 72.5])
...
def main():
    ...
    tests = [test_basic_functionality, test_room_simulation, test_comfort_controller, test_energy_calculations]
