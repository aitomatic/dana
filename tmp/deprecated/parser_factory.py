...
try:
    ...
    def grammar_parse(code: str) -> ParseResult:
        ...
        return ParseResult(
            ...
            errors=[ParseError("Grammar parser not available")]
        )
...
class ParserFactory:
    ...
    def parse(self, code: str, parser_type: Optional[ParserType] = None, 
              type_check: Optional[bool] = None) -> ParseResult:
