...
from opendxa.dana.language.ast import Literal, LiteralExpression, ReasonStatement
...
class TestReasonStatement(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_llm.query = AsyncMock(
            return_value=BaseResponse(success=True, content={"choices": [{"message": {"content": "This is a mock reasoning response"}}]})
        )
    ...
    def test_reason_with_context(self):
        ...
        # Check that the result was stored in the context
        self.assertEqual(self.context.get("private.analysis"), "This is a mock reasoning response")
    ...
    def test_reason_with_options(self):
        ...
        # Check that the result was stored in the context
        self.assertEqual(self.context.get("private.ideas"), "This is a mock reasoning response")
    ...
    def test_perform_reasoning(self):
        ...
        result = loop.run_until_complete(self.interpreter._perform_reasoning(prompt, context_vars, options))
