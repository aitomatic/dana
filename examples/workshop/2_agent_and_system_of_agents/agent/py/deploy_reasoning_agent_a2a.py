...
class ReasoningAgentA2A(A2AServer):
    ...
    def __init__(self):
        ...
        try:
            config = AgentConfig(
                agent_name="LangGraph Reasoning Agent",
                agent_description="Advanced reasoning agent with MCP tool integration"
            )
        ...
        try:
            ...
            task.status = TaskStatus(
                ...
                message={
                    ...
                    "content": {
                        "type": "text",
                        "text": f"I apologize, but I encountered a system error: {str(e)}"
                    }
                }
            )
