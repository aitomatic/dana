...
class ReasoningAgent:
    ...
    def _initialize_llm(self):
        ...
        if not os.getenv("OPENAI_API_KEY"):
            raise ValueError(
                ...
                "Please set your OpenAI API key to use this agent."
            )
            ...
            try:
                ...
                return {
                    **state,
                    ...
                    "reasoning_result": final_response.content
                }
            except Exception as e:
                print(f"❌ Error getting final response: {e}")
                return {
                    **state,
                    "reasoning_result": "I was able to gather information but had trouble providing a final response."
                }
        else:
    ...
    async def _format_response(self, state: ReasoningState) -> ReasoningState:
        ...
        return {
            **state,
            "reasoning_result": formatted_result
        }
