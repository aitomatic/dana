"""Question Answering Examples using DXA.

This example demonstrates different approaches to question answering using the DXA framework.
It showcases the flexibility of the execution system and how different strategies can be
applied to the same basic task.

Key concepts demonstrated:
1. Direct question answering with minimal workflow
2. Using the workflow-is-plan strategy for simple tasks
3. Multi-step reasoning with sequential workflows
4. The three-layer execution stack (Workflow → Plan → Reasoning)
5. Signal-based communication between execution layers
