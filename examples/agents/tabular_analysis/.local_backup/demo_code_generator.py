...
def main():
    ...
    indexer = DataFrameIndexerResource(workspace_root=str(dataset_dir), cache_dir=cache_dir, debug=False)
    ...
    code_result = code_generator.generate_and_execute(analysis_text=result["llm_analysis"], execute=True)
