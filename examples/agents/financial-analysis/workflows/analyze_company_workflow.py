"""
CompanyAnalysisWorkflow - Orchestrates the fraud detection pipeline.
...
class CompanyAnalysisWorkflow(BaseWorkflow):
    """
    ...
    def __init__(self, workflow_id: str | None = None, **kwargs):
        ...
        """
        super().__init__(workflow_id=workflow_id or "company-analysis-pipeline", **kwargs)

        # Store agent references

    @validate_input(
        company_name={"required": True, "type": str, "min_length": 1},
    )
    @validate_output(
