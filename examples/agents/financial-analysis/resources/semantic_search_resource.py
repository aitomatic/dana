    ...
    def search(self, query: str, top_k: int = 10) -> dict:
        ...
        try:
            ...
            if not self._rag.is_available:
                ...
                return {"results": [], "error": "Semantic search index is not available"}
            ...
            for result in results:
                try:
                    ...
                    formatted_results.append({"file_path": file_path, "content": content, "score": float(score)})
...
if __name__ == "__main__":
    ...
    resource = SemanticSearchResource(workspace_root="examples/agents/financial-analysis/data", debug=True)
