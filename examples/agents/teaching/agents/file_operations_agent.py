"""
FileOperationsAgent - Agent with complete file operation capabilities.
...
class BroadcastNotificationHandler(Notifiable):
    ...
    def __init__(self, agent_name: str = "FileOperationsAgent", verbose: bool = True):
        """
...
class FileOperationsAgent(STARAgent):
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        Initialize the FileOperationsAgent.
        ...
        super().__init__(
            ...
            agent_id=agent_id or "file-operations-001",
        ...
        self.notification_handler = BroadcastNotificationHandler("FileOperationsAgent")
...
if __name__ == "__main__":
    """
    Demo usage of FileOperationsAgent.
    ...
    print("=" * 80)
    print("FileOperationsAgent Demo")
    print("=" * 80)
    print()

    # Initialize the agent
    print("🤖 Initializing FileOperationsAgent with all file operation resources...")
    agent = FileOperationsAgent(workspace_root=str(Path.cwd()), model="gpt-4.1-mini")
