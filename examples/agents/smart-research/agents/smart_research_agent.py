"""SmartResearchAgent - Transparent research assistant with visible STAR loop."""
...
class SmartResearchAgent(STARAgent):
    ...
    Unlike black-box AI tools, SmartResearchAgent shows you:
    ...
    Features:
    - Adaptive strategy selection (4 types)
    - Parallel multi-source gathering
