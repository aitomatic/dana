...
from dana.lang.core.builtin_types.struct_system import InterfaceMethodSpec, InterfaceParameterSpec, InterfaceType
...
def create_interface_type_from_ast(interface_def) -> InterfaceType:
    ...
    """
    from dana.lang.core.lang.ast import InterfaceDefinition, InterfaceMethod
