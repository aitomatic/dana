...
from dana.lang.api.server import APIServiceManager
...
from dana.lang.core.builtin_types.resource.builtins.llm_resource_instance import LLMResourceInstance
from dana.lang.core.builtin_types.resource.builtins.llm_resource_type import LLMResourceType
from dana.lang.core.lang.interpreter.dana_interpreter import DanaInterpreter
from dana.lang.core.lang.parser.utils.parsing_utils import ParserCache
from dana.lang.core.lang.sandbox_context import SandboxContext
from dana.lang.core.runtime import DanaThreadPool

# from dana.lang.frameworks.poet.core.client import POETClient, set_default_client  # Removed for KISS
...
class DanaSandbox(Loggable):
    ...
    def __init__(self, debug_mode: bool = False, context: SandboxContext | None = None, module_search_paths: list[str] | None = None):
        ...
        try:
            ...
            if not self._interpreter.function_registry.has("len", None):
                ...
                from dana.lang.libs.corelib.py_wrappers.register_py_wrappers import _register_python_functions
    ...
    def execute_file(self, file_path: str | Path) -> ExecutionResult:
        ...
        try:
            ...
            from dana.lang.common.exceptions import EnhancedDanaError
            from dana.lang.core.lang.interpreter.error_formatter import EnhancedErrorFormatter
