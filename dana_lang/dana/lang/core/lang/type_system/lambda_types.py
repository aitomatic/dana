...
from dana.lang.core.lang.ast import LambdaExpression, Parameter
from dana.lang.core.lang.parser.utils.type_checker import DanaType, TypeEnvironment
...
class LambdaTypeInferencer:
    ...
    def infer_lambda_type(self, lambda_expr: LambdaExpression, context_type: DanaType | None = None) -> DanaType:
        ...
        try:
            ...
            from dana.lang.core.lang.parser.utils.type_checker import TypeChecker
