...
from dana.lang.core.lang.ast import (
    AttributeAccess,
    BinaryExpression,
    BinaryOperator,
...
from dana.lang.core.lang.parser.transformer.base_transformer import BaseTransformer
from dana.lang.core.lang.parser.transformer.expression.expression_helpers import (
    OperatorHelper,
)
...
class ExpressionTransformer(BaseTransformer):
    ...
    def conditional_expr(self, items):
        ...
        from dana.lang.core.lang.ast import ConditionalExpression
    ...
    def _is_literal_expression(self, expr):
        ...
        from dana.lang.core.lang.ast import LiteralExpression
    ...
    def not_expr(self, items):
        ...
        if is_not_op:
            ...
            from dana.lang.core.lang.ast import Expression
    ...
    def atom(self, items):
        ...
        if isinstance(item, Tree):
            ...
            if item.data == "collection" and len(item.children) == 1:
                ...
                from dana.lang.core.lang.ast import DictLiteral, SetLiteral, TupleLiteral
    ...
    def tuple(self, items):
        from dana.lang.core.lang.ast import Expression, TupleLiteral
    ...
    def dict(self, items):
        ...
        """
        from dana.lang.core.lang.ast import DictLiteral
    ...
    def set(self, items):
        ...
        """
        from dana.lang.core.lang.ast import Expression, SetLiteral
    ...
    def trailer(self, items):
        ...
        """
        from dana.lang.core.lang.parser.transformer.trailer_processor import TrailerProcessor
    ...
    def string(self, items):
        ...
        if isinstance(item, Token):
            if item.type == "REGULAR_STRING":
                ...
                from dana.lang.core.lang.parser.transformer.fstring_transformer import (
                    FStringTransformer,
                )
    ...
    def slice_list(self, items):
        ...
        if len(items) == 1:
            ...
            from dana.lang.core.lang.ast import SliceTuple
    ...
    def pipeline_stage(self, items):
        ...
        if len(items) == 1:
            ...
            from dana.lang.core.lang.ast import NamedPipelineStage
    ...
    def function_call(self, items):
        ...
        if self._contains_placeholder(arguments):
            ...
            # from dana.lang.core.lang.ast import PipelineExpression
    ...
    def _is_placeholder_expression(self, expr):
        ...
        from dana.lang.core.lang.ast import PlaceholderExpression
    ...
    def lambda_expr(self, items):
        ...
        from dana.lang.core.lang.parser.transformer.expression.lambda_transformer import LambdaTransformer
    ...
    def list_comprehension(self, items):
        ...
        from dana.lang.core.lang.ast import ListComprehension
    ...
    def set_comprehension(self, items):
        ...
        from dana.lang.core.lang.ast import SetComprehension
    ...
    def dict_comprehension(self, items):
        ...
        from dana.lang.core.lang.ast import DictComprehension
