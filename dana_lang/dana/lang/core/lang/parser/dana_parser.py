...
from dana.lang.common.exceptions import ParseError
from dana.lang.common.mixins.loggable import Loggable
from dana.lang.core.lang.ast import Program
from dana.lang.core.lang.parser.transformer.dana_transformer import DanaTransformer
from dana.lang.core.lang.parser.utils.metadata_processor import MetadataProcessor
from dana.lang.core.lang.parser.utils.type_checker import TypeChecker, TypeEnvironment
...
class DanaParser(Lark, Loggable):
    ...
    def transform(self, parse_tree: Tree, do_type_check: bool = False) -> Program:
        ...
        if self.current_filename:
            from dana.lang.core.lang.ast import Location
