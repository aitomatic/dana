...
from dana.lang.common.exceptions import StateError
...
from dana.lang.core.lang.parser.utils.scope_utils import extract_scope_and_name
...
if TYPE_CHECKING:
    ...
    from dana.lang.core.lang.context_manager import ContextManager
...
class SandboxContext(Loggable):
    ...
    def __init__(self, parent: Optional["SandboxContext"] = None, manager: Optional["ContextManager"] = None):
        ...
        from dana.lang.core.lang.interpreter.error_context import ErrorContext
