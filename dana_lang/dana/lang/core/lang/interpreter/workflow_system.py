...
from dana.lang.core.builtin_types.fsm_system import create_fsm_struct_type, create_simple_workflow_fsm
...
class WorkflowInstance(StructInstance):
    ...
    def __init__(self, struct_type: WorkflowType, values: dict[str, Any]):
        ...
        from dana.lang.registry import WORKFLOW_REGISTRY
...
def create_workflow_type_from_ast(workflow_def) -> WorkflowType:
    ...
    """
    from dana.lang.core.lang.ast import WorkflowDefinition
