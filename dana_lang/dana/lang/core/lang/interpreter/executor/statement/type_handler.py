...
from dana.lang.core.lang.ast import InterfaceDefinition, StructDefinition
...
class TypeHandler(Loggable):
    ...
    def execute_struct_definition(self, node: StructDefinition, context: SandboxContext) -> None:
        ...
        from dana.lang.core.builtin_types.struct_system import create_struct_type_from_ast
    ...
    def execute_interface_definition(self, node: InterfaceDefinition, context: SandboxContext) -> None:
        ...
        """
        # Import here to avoid circular imports
        from dana.lang.core.builtin_types.interface_system import create_interface_type_from_ast
        from dana.lang.registry import TYPE_REGISTRY
