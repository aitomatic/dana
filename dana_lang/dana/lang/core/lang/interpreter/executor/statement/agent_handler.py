...
class AgentHandler(Loggable):
    ...
    def execute_singleton_agent_definition(self, node: SingletonAgentDefinition, context: SandboxContext) -> None:
        ...
        try:
            ...
            from dana.lang.core.builtin_types.agent_system import AgentInstance, AgentType
            from dana.lang.registry import get_agent_type, register_agent_type
    ...
    def execute_function_definition(self, node: FunctionDefinition, context: SandboxContext) -> Any:
        ...
        # from dana.lang.core.builtin_types.agent_system import register_agent_method_from_function_def
