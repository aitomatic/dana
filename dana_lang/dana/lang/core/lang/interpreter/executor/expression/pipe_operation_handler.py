...
from dana.lang.core.lang.interpreter.functions.composed_function import ComposedFunction
...
class ParallelFunction(SandboxFunction):
    ...
    def execute(self, context: SandboxContext, *args, **kwargs) -> list[Any]:
        ...
        from dana.lang.core.concurrency.promise_utils import resolve_if_promise
...
class NamedPipelineComposedFunction(SandboxFunction):
    ...
    def execute(self, context: SandboxContext, *args, **kwargs) -> Any:
        ...
        if self._pipeline_executor is None:
            from dana.lang.core.lang.interpreter.executor.expression.pipeline_executor import PipelineExecutor
...
class PipeOperationHandler(Loggable):
    ...
    def _resolve_lambda_expression(self, lambda_expr: Any, context: SandboxContext) -> Any:
        ...
        try:
            from dana.lang.core.lang.interpreter.pipeline.lambda_pipeline import LambdaPipelineIntegrator
