...
from dana.lang.core.lang.interpreter.executor.statement import (
    AgentHandler,
    AssignmentHandler,
    ImportHandler,
    StatementUtils,
)
from dana.lang.core.lang.interpreter.executor.statement.type_handler import TypeHandler
...
class StatementExecutor(BaseExecutor):
    ...
    def unused_execute_dana_import(self, module_name: str, context_name: str, context: SandboxContext) -> None:
        ...
        from dana.lang.__init__.init_modules import get_module_loader
    ...
    def unused_register_imported_function(self, func: callable, context_name: str, module_name: str, original_name: str) -> None:
        ...
        from dana.lang.registry.function_registry import FunctionMetadata
    ...
    def execute_resource_definition(self, node: ResourceDefinition, context: SandboxContext) -> None:
        ...
        from dana.lang.common.exceptions import SandboxError
        from dana.lang.core.builtin_types.resource.resource_ast import create_resource_type_from_ast
    ...
    def execute_workflow_definition(self, node, context: SandboxContext) -> None:
        ...
        # Import lazily to avoid circulars
        from dana.lang.common.exceptions import SandboxError
        from dana.lang.core.builtin_types.workflow_system import create_workflow_type_from_ast
    ...
    def _execute_composition(self, composition, func_context: SandboxContext, args: tuple) -> Any:
        ...
        from dana.lang.core.lang.ast import ListLiteral

        if isinstance(composition, ListLiteral):
            # Convert ListLiteral to ParallelFunction for parallel composition
            from dana.lang.core.lang.interpreter.executor.expression.pipe_operation_handler import PipeOperationHandler
        ...
        from dana.lang.core.lang.interpreter.functions.sandbox_function import SandboxFunction
