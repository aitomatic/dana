...
from dana.lang.core.lang.interpreter.executor.base_executor import BaseExecutor
from dana.lang.core.lang.interpreter.executor.function_error_handling import (
    FunctionExecutionErrorHandler,
)
from dana.lang.core.lang.interpreter.executor.function_name_utils import FunctionNameInfo
from dana.lang.core.lang.interpreter.executor.resolver.unified_function_dispatcher import (
...
class FunctionExecutor(BaseExecutor):
    ...
    def _ensure_fully_evaluated(self, value: Any, context: SandboxContext) -> Any:
        ...
        from dana.lang.core.concurrency import is_promise
    ...
    def execute_function_call(self, node: FunctionCall, context: SandboxContext) -> Any:
        ...
        if hasattr(node, "location") and node.location:
            from dana.lang.core.lang.interpreter.error_context import ExecutionLocation
        ...
        from dana.lang.core.lang.ast import AttributeAccess
        ...
        from dana.lang.core.lang.ast import SubscriptExpression
    ...
    def _apply_function_result_coercion(self, result: Any, function_name: str) -> Any:
        ...
        """
        try:
            from dana.lang.core.lang.interpreter.unified_coercion import TypeCoercion
    ...
    def _execute_user_defined_function(self, func_data: dict[str, Any], args: list[Any], context: SandboxContext) -> Any:
        ...
        try:
            ...
            from dana.lang.core.lang.interpreter.executor.control_flow.exceptions import (
                ReturnException,
            )
    ...
    def __check_struct_instantiation(self, node: FunctionCall, context: SandboxContext, evaluated_kwargs: dict[str, Any]) -> Any | None:
        ...
        from dana.lang.core.builtin_types.struct_system import create_struct_instance
        ...
        try:
            ...
            try:
                ...
                if func_obj is not None:
                    ...
                    from dana.lang.core.lang.interpreter.functions.dana_function import (
                        DanaFunction,
                    )
            ...
            from dana.lang.core.lang.interpreter.struct_functions.lambda_receiver import LambdaMethodDispatcher
    ...
    def __execute_subscript_call_from_string(
        ...
        try:
            ...
            from dana.lang.core.lang.ast import Identifier
    ...
    def _extract_receiver_types(self, receiver_param: Parameter) -> list[str]:
        ...
        for type_name in receiver_types:
            ...
            try:
                from dana.lang.core.builtin_types.resource.resource_registry import ResourceTypeRegistry
