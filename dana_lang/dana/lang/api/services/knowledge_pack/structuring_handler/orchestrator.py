from dana.lang.api.services.intent_detection.intent_handlers.abstract_handler import AbstractHandler
from dana.lang.api.services.knowledge_pack.structuring_handler.tools import (
    AskQuestionTool,
...
from dana.lang.api.core.schemas_v2 import HandlerConversation, HandlerMessage, SenderRole
from dana.lang.api.core.schemas import DomainKnowledgeTree, DomainNode
from dana.lang.api.services.intent_detection.intent_handlers.handler_utility import knowledge_ops_utils as ko_utils
from pathlib import Path
from dana.lang.common.utils.misc import Misc
import logging
from dana.lang.api.services.knowledge_pack.structuring_handler.prompts import TOOL_SELECTION_PROMPT
...
class KPStructuringOrchestrator(AbstractHandler):
    ...
    def _reload_tree_structure(self):
        ...
        try:
            ...
            if "question_bank_generation" in self.tools:
                self.tools["question_bank_generation"].tree_structure = self.tree_structure
