            ...
            input_schema=InputSchema(
                ...
                properties=[
                    ...
                    BaseArgument(
                        name="options",
                        type="list",
                        description="Provide option if there is one relevant next step or choice. Provide only ONE option. Use when presenting option to the user after completing a task or when asking for next action. Option must be a complete user response that makes sense when sent as the next message. If the summary is about added topics successfully, the option must be Generate questions for added topics. If the summary is about added questions successfully, then we don't need to provide options",
