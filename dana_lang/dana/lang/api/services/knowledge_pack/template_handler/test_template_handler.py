...
import tempfile
import os
from dana.lang.api.core.schemas import IntentDetectionRequest
...
**Listen for connections to**: Emergency Response, Training
...
**Listen for connections to**: Documentation, Continuous Improvement
