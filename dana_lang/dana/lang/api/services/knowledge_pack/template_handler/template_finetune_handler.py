...
from dana.lang.api.core.schemas import IntentDetectionRequest, MessageData
...
from dana.lang.api.services.knowledge_pack.template_handler.tools import (
    ViewTemplateTool,
    RefineTopicQuestionsTool,
    GenerateAdditionalQuestionsTool,
    ReplaceInFileTool,
)
from dana.lang.api.services.knowledge_pack.template_handler.prompts import TEMPLATE_FINETUNE_PROMPT
...
class TemplateFinetuneHandler(AbstractHandler):
    ...
    async def _initialize_rag(self) -> None:
        ...
        knows_dir = Path(self.knowledge_pack_path) / "knows"
        if knows_dir.exists():
    ...
    async def handle(self, request: IntentDetectionRequest) -> dict[str, Any]:
        ...
        for _ in range(15):
            ...
            try:
                ...
                conversation.append(MessageData(role=SenderRole.USER, content=f"Error: {e}"))
    ...
    async def _execute_tool(self, tool_name: str, params: dict, thinking_content: str) -> MessageData:
        ...
        try:
            ...
            # Add context parameters (none needed since all context is in constructor)
            context_params = {}
