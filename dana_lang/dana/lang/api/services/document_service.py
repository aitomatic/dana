...
from dana.lang.api.core.models import Document, Agent
from dana.lang.api.core.schemas import DocumentCreate, DocumentRead, DocumentUpdate
...
class DocumentService:
    ...
    async def _build_index_for_agent(self, agent_id: int, file_path: str, db_session) -> None:
        ...
        try:
            ...
            from dana.lang.api.core.database import engine
