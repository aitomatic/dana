...
from dana.lang.api.core.models import Topic
from dana.lang.api.core.schemas import TopicCreate, TopicRead
    ...
    async def delete_topic(self, topic_id: int, db_session, force: bool = False) -> bool:
        ...
        try:
            ...
            if documents:
                ...
                from dana.lang.api.services.document_service import DocumentService
