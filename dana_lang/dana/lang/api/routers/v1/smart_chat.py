...
from dana.lang.api.core.models import Agent, AgentChatHistory
...
from dana.lang.api.services.intent_detection_service import (
    get_intent_detection_service,
    IntentDetectionService,
)
from dana.lang.api.services.llm_tree_manager import get_llm_tree_manager, LLMTreeManager
from dana.lang.api.services.knowledge_status_manager import KnowledgeStatusManager
from dana.lang.api.routers.v1.agents import clear_agent_cache
from dana.lang.api.services.intent_detection.intent_handlers.knowledge_ops_handler import KnowledgeOpsHandler
from dana.lang.common.sys_resource.llm.legacy_llm_resource import LegacyLLMResource as LLMResource
from dana.lang.api.services.auto_knowledge_generator import get_auto_knowledge_generator
import os
import json
    ...
    try:
        ...
        if update_response.success and update_response.updated_tree:
            ...
            if save_success:
                ...
                try:
                    from dana.lang.api.services.domain_knowledge_version_service import get_domain_knowledge_version_service
