...
from dana.lang.api.repositories import AbstractDomainKnowledgeRepo, AbstractBackgroundTaskRepo, AbstractDocumentRepo
from dana.lang.api.repositories import get_domain_knowledge_repo, get_background_task_repo, get_document_repo
from dana.lang.api.core.database import get_db
from dana.lang.api.core.schemas_v2 import KnowledgeGenerationResponse, BackgroundTaskResponse
...
async def generate_knowledge(
    ...
    try:
        ...
        task_data = {
            ...
            "knowledge_status_path": str(knows_path / "knowledge_status.json"),
            "domain": spec.domain,
            "role": spec.role,
            "tasks": [spec.task],
        }
