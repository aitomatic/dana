...
from dana.lang.api.core.schemas import MessageCreate, ConversationCreate, IntentDetectionRequest, MessageData
...
from dana.lang.api.repositories.interview_template_repo import AbstractInterviewTemplateRepo
from dana.lang.api.repositories.domain_knowledge_repo import AbstractDomainKnowledgeRepo
from dana.lang.api.services.knowledge_pack.template_handler.template_finetune_handler import TemplateFinetuneHandler
...
async def get_interview_template(
    ...
    try:
        ...
        from dana.lang.api.core.schemas_v2 import InterviewTemplateRead
...
async def get_template_conversation(
    ...
    try:
        ...
        from dana.lang.api.core.schemas import ConversationWithMessages
...
async def update_interview_template(
    ...
    try:
        ...
        if request.name and request.name != current_template.name:
            old_folder = Path(current_template.folder_path)

            if old_folder.exists():
                # Update the README with new name and description
                readme_file = old_folder / "README.md"
                if readme_file.exists():
                    readme_file.write_text(
                        f"# {updated_template.name}\n\n{updated_template.description or 'Interview template'}\n\n*Template updated on {updated_template.updated_at}*\n"
                    )
