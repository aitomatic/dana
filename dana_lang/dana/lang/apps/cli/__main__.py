...
from dana.lang.core.lang.log_manager import LogLevel, SandboxLogger
...
def start_repl():
    ...
    try:
        from dana.lang.apps.repl.__main__ import main as repl_main
...
def start_tui():
    ...
    try:
        from dana.lang.apps.tui.__main__ import main as tui_main
...
def main():
    ...
    try:
        ...
        parser_studio.add_argument("--skip-build", action="store_true", help="Skip building the frontend before starting the server")
...
def deploy_thru_mcp(file_path, args):
    ...
    try:
        from dana.lang.apps.cli.deploy.mcp import deploy_dana_agents_thru_mcp
...
def deploy_thru_a2a(file_path, args):
    ...
    try:
        from dana.lang.apps.cli.deploy.a2a import deploy_dana_agents_thru_a2a
...
def deploy_thru_restful(file_path, args):
    ...
    try:
        from dana.lang.apps.cli.deploy.restapi import deploy_dana_agent_rest_api
