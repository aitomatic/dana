...
from dana.lang.apps.repl.commands import CommandHandler
from dana.lang.apps.repl.input import InputProcessor
from dana.lang.apps.repl.repl import REPL
from dana.lang.apps.repl.ui import OutputFormatter, PromptSessionManager, WelcomeDisplay
from dana.lang.common.error_utils import DanaError
...
from dana.lang.common.terminal_utils import ColorScheme
from dana.lang.core.concurrency.base_promise import BasePromise
from dana.lang.core.lang.log_manager import LogLevel
from dana.lang.core.runtime import DanaThreadPool
...
async def main(debug: bool = False) -> None:
    ...
    # When called from dana.lang.py, debug parameter is passed directly
    # When called as module (__main__.py), parse command line arguments
    if debug is not False or len(sys.argv) == 1:
        # Called from dana.lang.py with debug parameter
    ...
    try:
        ...
        if use_fullscreen:
            ...
            from dana.lang.apps.repl.repl import REPL
            from dana.lang.apps.repl.ui.fullscreen_repl import FullScreenREPL
            from dana.lang.common.sys_resource.llm.legacy_llm_resource import LegacyLLMResource
            from dana.lang.common.terminal_utils import ColorScheme
...
class DanaREPLApp(Loggable):
    ...
    def __init__(self, log_level: LogLevel = LogLevel.WARN):
        ...
        from dana.lang.common.terminal_utils import supports_color
