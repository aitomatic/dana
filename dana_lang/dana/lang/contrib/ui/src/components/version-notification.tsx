    ...
    <div className="w-full px-4 py-2">
      <div className="flex items-center justify-between p-3 bg-orange-50 border border-orange-200 rounded-sm">
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold">You're using an older version of Dana Agent Studio ({versionService.formatVersion(versionInfo.current)}). </span>
          <span className="font-normal">For the best experience and latest features, please update to the latest version {versionService.formatVersion(versionInfo.latest)} .</span>
          </span>
        </div>
        <Button
          size="sm"
