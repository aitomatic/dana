...
from dana_lang.api.core.schemas import ChatRequest, ChatResponse, ConversationCreate, MessageCreate
...
class ChatService:
    ...
    async def _generate_agent_response(
        ...
        try:
            ...
            from __init__ import initialize_module_system, reset_module_system
