...
from dana_lang.common.terminal_utils import ColorScheme, print_header, supports_color
...
def start_repl():
    ...
    try:
        from dana_lang.apps.repl.__main__ import main as repl_main
...
def start_tui():
    ...
    try:
        from dana_lang.apps.tui.__main__ import main as tui_main
...
def deploy_thru_mcp(file_path, args):
    ...
    try:
        from dana_lang.apps.cli.deploy.mcp import deploy_dana_agents_thru_mcp
...
def deploy_thru_a2a(file_path, args):
    ...
    try:
        from dana_lang.apps.cli.deploy.a2a import deploy_dana_agents_thru_a2a
...
def deploy_thru_restful(file_path, args):
    ...
    try:
        from dana_lang.apps.cli.deploy.restapi import deploy_dana_agent_rest_api
