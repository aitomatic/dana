...
class TreeTraverser(Loggable):
    ...
    def unwrap_token(self, token: Token) -> Any:
        ...
        """
        from dana_lang.core.lang.parser.utils.transformer_utils import extract_token_value
    ...
    def unwrap_single_child_tree(self, node: Any) -> Any:
        ...
        Delegates to transformer_utils for consistency.
        """
        from dana_lang.core.lang.parser.utils.transformer_utils import unwrap_single_child_tree
