...
def py_reason(
    ...
    **Supported Context Patterns:**
    ...
    try:
        ...
        from dana_lang.core.lang.interpreter.context_detection import ContextDetector
        from dana_lang.core.lang.interpreter.enhanced_coercion import SemanticCoercer
        from dana_lang.core.lang.interpreter.prompt_enhancement import enhance_prompt_for_type
