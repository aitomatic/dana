...
def py_use(
    ...
    if function_name.lower() == "mcp":
        ...
        from dana_lang.common.sys_resource.rag.rag_resource_v2 import RAGResourceV2
        ...
        from dana_lang.common.sys_resource.rag.knowledge_resource import KnowledgeResource
        ...
        from dana_lang.common.sys_resource.rag.financial_statement_rag_resource import FinancialStatementRAGResource
        ...
        from dana_lang.common.sys_resource.coding.coding_resource import CodingResource
        ...
        from dana_lang.common.sys_resource.tabular_index.tabular_index_resource import TabularIndexResource
