      ...
      try {
        ...
        if (response.success && response.data) {
          ...
          const packData = {
            ...
            // Only preserve originalDescription from navigation state (for newly created packs)
            // On page refresh, originalDescription will be undefined, preventing auto-message
