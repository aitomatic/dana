...
export const ExtractedFile = ({ selectedFile, onFileUpload }: ExtractedFileProps) => {
  ...
  return (
    <div className="flex overflow-auto flex-col gap-4 w-full max-w-full h-full">
      <div className="flex overflow-auto flex-1 gap-4 w-full max-w-full min-h-0">
        {hasPreview ? (
                ...
                <div className="flex justify-between items-center pt-4 pb-4 bg-white">
                  <div className="flex gap-2 items-center">
                    <div className="flex size-6">
                      <FileIcon ext={fileType.extension} className="text-gray-600 size-6" />
                    </div>
                    <span className="text-md font-medium text-gray-900 truncate max-w-[350px]">
                      {fileName}
                    </span>
                  </div>
                </div>
              ...
              <div className="flex flex-col w-full h-full bg-gray-50 rounded-lg border-gray-200 border-1">
                ...
                <div className="flex gap-2 justify-between items-center p-3">
                  <div className="flex flex-col gap-2">
                    ...
                    {showDeepExtractionStatus &&
                      selectedFile?.is_deep_extracted &&
                      selectedFile?.deep_extracted_documents?.length > 0 && (
                        <div>
                          <Badge variant="default" className="text-sm text-white bg-blue-600">
                            Deep extracted
                          </Badge>
                        </div>
                      )}
