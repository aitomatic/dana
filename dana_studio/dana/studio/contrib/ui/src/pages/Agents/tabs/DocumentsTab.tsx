...
const DocumentsTab: React.FC = () => {
  ...
  const EmptyState = () => {
    return (
      <div className="flex flex-col items-center justify-center h-[100%] border-2 border-dashed border-gray-300 rounded-lg">
        <div className="flex flex-col justify-center items-center mb-4 bg-gray-100 rounded-full w-22 h-22">
  ...
  return (
    <div className="flex flex-col gap-4 px-6 pb-6 h-full bg-white rounded-lg">
      ...
      <div className="flex items-center space-x-4 w-full space-between">
