      ...
      <div
        className={` relative overflow-hidden transition-all duration-700 ease-out ${
          headerCollapsed
            ...
            : 'py-16 bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900 min-h-[600px]'
        }`}
      >
      ...
      <div className="flex-1 p-8 bg-white">
        ...
        <div className="flex flex-col gap-4 mb-8 md:flex-row md:items-center md:justify-between">
          <div className="flex flex-col gap-4 justify-between items-center w-full md:flex-row">
            <div className="relative flex w-full md:w-72 pt-4 ">
              <Search className="absolute items-center justify-center -translate-y-1 top-1/2 left-3 text-gray-400 size-5" />
              <input
                type="text"
                placeholder="Search"
