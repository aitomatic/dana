...
// Knowledge Pack Generation Status
// Must match backend: dana.api.core.schemas_v2.KnowledgeGenerationStatus
export const KNOWLEDGE_GENERATION_STATUS = {
  DRAFT: 'draft',
...
export type KnowledgeGenerationStatus =
  (typeof KNOWLEDGE_GENERATION_STATUS)[keyof typeof KNOWLEDGE_GENERATION_STATUS];

// Template Generation Status
export const TEMPLATE_GENERATION_STATUS = {
  DRAFT: 'draft',
  PENDING: 'pending',
  GENERATING: 'generating',
  COMPLETED: 'completed',
...
export type TemplateGenerationStatus =
  (typeof TEMPLATE_GENERATION_STATUS)[keyof typeof TEMPLATE_GENERATION_STATUS];

// Interview Session Status
// Must match backend: dana.api.core.schemas_v2.InterviewSessionStatus
