"""Configuration utilities for planning."""
...
class PlanConfig(ExecutionConfig):
    """Utilities for loading and managing planning configurations."""
    
    @classmethod
    def get_config_path(cls, config_ref: str) -> Path:
        """Get path to planning configuration file."""
        return super().get_config_path(config_ref, "planning")
    
    @classmethod
    def load_yaml(cls, planning_name: str) -> Dict:
        """Load planning configuration from YAML file."""
        return super().load_config(planning_name, "planning")

    @classmethod
    def reload_config(cls, planning_name: str) -> Dict:
        """Force reload of planning configuration from YAML file."""
        return super().load_config(planning_name, "planning")
