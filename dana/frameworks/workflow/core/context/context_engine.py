...
class ContextEngine:
    ...
    def create_context_snapshot(self, metadata: Optional[Dict[str, Any]] = None) -> str:
        """
        ...
        snapshot = ContextSnapshot(
            id=snapshot_id,
            timestamp=datetime.now(),
            knowledge_points=list(self._knowledge_store.values()),
            metadata=metadata or {}
        )
    ...
    def clear_knowledge(self, source: Optional[str] = None) -> int:
        """
    ...
    def _enforce_limit(self) -> None:
        ...
        if len(self._knowledge_store) > self.max_knowledge_points:
            ...
            sorted_knowledge = sorted(
                self._knowledge_store.values(),
                key=lambda kp: kp.timestamp
            )
    ...
    def export_knowledge(self, source: Optional[str] = None) -> Dict[str, Any]:
        """
