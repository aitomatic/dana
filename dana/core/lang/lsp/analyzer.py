...
from dana.core.lang.ast import Program, Identifier, FunctionCall, LiteralExpression
...
class DanaAnalyzer:
    ...
    def __init__(self):
        ...
        self.dana_keywords = [
            "def", "if", "else", "elif", "while", "for", "try", "except", "finally",
        ...
        self.dana_builtin_functions = [
            ...
            "print", "reason", "len", "str", "int", "float", "bool",
    ...
    async def get_hover(self, text: str, line: int, character: int) -> Optional[str]:
    ...
    def _get_dana_hover_info(self, word: str) -> Optional[str]:
