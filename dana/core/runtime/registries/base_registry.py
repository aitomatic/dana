...
class BaseRegistry(Generic[K, T], ABC):
    ...
    def _initialize_storage(self) -> None:
        ...
        # Each registry class gets its own storage
        if not hasattr(self.__class__, "_storage"):
            self.__class__._storage = {}

    @classmethod
    @abstractmethod
    def register(cls, item: T, key: K | None = None, **kwargs) -> None:
