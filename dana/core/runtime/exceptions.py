...
class DanaException:
    ...
    filename: Optional[str] = None   # File where error occurred
    line: Optional[int] = None       # Line number where error occurred
    column: Optional[int] = None     # Column number where error occurred
    source_line: Optional[str] = None # Source code line where error occurred
