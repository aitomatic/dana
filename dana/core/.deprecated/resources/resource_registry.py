...
class ResourceRegistry:
    ...
    def __init__(self):
        self._resources: dict[str, Any] = {}  # ResourceInstance or any resource type
        self._blueprints: dict[str, type[Any]] = {}
    ...
    def register_blueprint(self, name: str, blueprint_class: type[Any], metadata: dict[str, Any] = None):
    ...
    def create_resource(self, kind: str, name: str, agent_name: str, **kwargs) -> Any:
    ...
    def list_resources(self, agent_name: str = None) -> list[Any]:
    ...
    def create_from_handle(self, handle: ResourceHandle, agent_name: str) -> Any:
