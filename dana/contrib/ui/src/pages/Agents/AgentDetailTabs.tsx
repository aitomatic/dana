  ...
  return (
    <div className="flex-1 flex flex-col overflow-auto h-full">
      ...
      {activeTab === 'Domain Knowledge' && (
        <div className="p-8 text-gray-500">Domain Knowledge content (placeholder)</div>
      )}
      {activeTab === 'Documents' && (
        <div className="p-8 text-gray-500">Documents content (placeholder)</div>
      )}
      {activeTab === 'Workflows' && (
        <div className="p-8 text-gray-500">Workflows content (placeholder)</div>
      )}
      {activeTab === 'Tools' && (
        <div className="p-8 text-gray-500">Tools content (placeholder)</div>
      )}
      {activeTab === 'Code' && (
        <div className="p-8 text-gray-500">Code content (placeholder)</div>
      )}
      {children}
    </div>
  );
