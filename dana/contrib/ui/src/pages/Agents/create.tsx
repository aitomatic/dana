...
import { CloudUpload, Edit, Xmark } from 'iconoir-react';
...
export function CreateAgentPage() {
  const { form, onCreateAgent } = useDanaAgentForm();
  ...
  const general_agent_config = watch('general_agent_config');

  const isDisabled = !name || !general_agent_config.dana_code;
