    ...
    <div className="flex flex-col w-full h-full overflow-hidden">
      ...
      <div 
        className={`relative overflow-hidden transition-all duration-700 ease-out ${
          headerCollapsed 
            ? 'min-h-[200px] bg-gradient-to-r from-slate-900 to-purple-900' 
            : 'min-h-[600px] bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 py-16'
        }`}
      >
        ...
        <div className={`relative z-10 flex flex-col items-center justify-center text-center transition-all duration-700 ease-out ${
          headerCollapsed ? 'h-0 overflow-hidden' : 'min-h-[600px] px-6'
        }`}>
          
          {/* Main Title with Enhanced Typography */}
          <div className={`transition-all duration-700 ease-out ${
            headerCollapsed ? 'mb-0 scale-75 opacity-0' : 'mb-8 scale-100 opacity-100'
          }`}>
          ...
          {/* Enhanced Subtitle */}
          <p className={`text-xl md:text-2xl text-gray-200 max-w-4xl leading-relaxed font-light transition-all duration-700 ease-out ${
            headerCollapsed ? 'mb-0 scale-75 opacity-0' : 'mb-12 scale-100 opacity-100'
          }`}>
          ...
          <div className={`grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl transition-all duration-700 ease-out ${
            headerCollapsed ? 'mb-0 scale-75 opacity-0' : 'mb-16 scale-100 opacity-100'
          }`}>
            ...
            <div className="group bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 transition-all duration-500 hover:scale-105 relative">
              <div className="absolute top-4 right-4">
                <span className="px-2 py-1 text-xs font-semibold bg-yellow-500/20 text-yellow-300 border border-yellow-400/40 rounded-full">Coming Soon</span>
              </div>
          ...
          <div className={`flex flex-col items-center gap-4 transition-all duration-700 ease-out ${
            headerCollapsed ? 'scale-75 opacity-0' : 'scale-100 opacity-100'
          }`}>
            <button 
              onClick={() => {
