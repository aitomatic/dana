...
```"""
    ...
    def _generate_fallback_response(self, message: str, context: str) -> str:
        ...
        if any(greeting in message_lower for greeting in ["hello", "hi", "hey", "greetings"]):
            fallback_response["content"] = f"Hello! I'm {self.agent_type.name}. How can I help you today?"
        ...
        # Check for name queries
            ...
            fallback_response["content"] = f"I'm {self.agent_type.name}, an AI agent. How can I assist you?"
