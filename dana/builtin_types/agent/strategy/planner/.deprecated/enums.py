"""
Planner Strategy Enums.

This module defines enums specific to the plan-then-execute strategy.
These enums are used for plan types, problem complexity, and confidence levels.
"""
...
class PlanType(Enum):
    """Enum for different approach types in planner strategy problem solving."""
...
class ProblemComplexity(Enum):
    """Enum for problem complexity levels in planner strategy."""
...
class ConfidenceLevel(Enum):
    """Enum for confidence levels in planner strategy decisions."""
