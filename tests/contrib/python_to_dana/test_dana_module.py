...
def test_dana_initialization(params):
    ...
    with patch("dana.integrations.python.to_dana.dana_module.InProcessSandboxInterface", return_value=mock_sandbox_interface):
...
def test_dana_reason_type_validation(test_data):
    ...
    with patch("dana.integrations.python.to_dana.dana_module.InProcessSandboxInterface") as mock_interface_class:
        mock_interface = Mock()
...
def test_dana_subprocess_isolation_placeholder():
    ...
    with (
        patch("dana.integrations.python.to_dana.dana_module.InProcessSandboxInterface") as mock_inprocess,
        patch("dana.integrations.python.to_dana.dana_module.SubprocessSandboxInterface") as mock_subprocess,
    ):
