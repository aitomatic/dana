...
class TestUnderscorePrivacy:
    ...
    def test_public_function_import_succeeds(self):
        ...
        result = self.sandbox.execute_string("from privacy_test import public_function")
        assert result.success, f"Failed to import public function: {result.error}"

        # Test the function can be called
        call_result = self.sandbox.execute_string("public_function()")
    ...
    def test_public_constant_import_succeeds(self):
        ...
        result = self.sandbox.execute_string("from privacy_test import PUBLIC_CONSTANT")
        assert result.success, f"Failed to import public constant: {result.error}"

        # Test the constant value
        value_result = self.sandbox.execute_string("PUBLIC_CONSTANT")
    ...
    def test_private_function_import_fails(self):
        ...
        result = self.sandbox.execute_string("from privacy_test import _private_function")
    ...
    def test_private_constant_import_fails(self):
        ...
        result = self.sandbox.execute_string("from privacy_test import _PRIVATE_CONSTANT")
    ...
    def test_private_struct_import_fails(self):
        ...
        result = self.sandbox.execute_string("from privacy_test import _PrivateStruct")
    ...
    def test_helper_function_import_fails(self):
        ...
        result = self.sandbox.execute_string("from privacy_test import _helper_function")
    ...
    def test_public_function_can_use_private_internally(self):
        ...
        result = self.sandbox.execute_string("from privacy_test import get_public_data")
        assert result.success, f"Failed to import public function: {result.error}"

        # Test the function can be called and uses private function internally
        call_result = self.sandbox.execute_string("get_public_data()")
    ...
    def test_multiple_public_imports_succeed(self):
        ...
        result = self.sandbox.execute_string("from privacy_test import public_function, PUBLIC_CONSTANT, describe_module")
        assert result.success, f"Failed to import multiple public names: {result.error}"

        # Test all imports work
        func_result = self.sandbox.execute_string("public_function()")
        assert func_result.success and func_result.result == "This is a public function"

        const_result = self.sandbox.execute_string("PUBLIC_CONSTANT")
        assert const_result.success and const_result.result == "This is a public constant"

        desc_result = self.sandbox.execute_string("describe_module()")
    ...
    def test_mixed_public_private_import_fails(self):
        ...
        result = self.sandbox.execute_string("from privacy_test import public_function, _private_function")
    ...
    def test_module_level_import_still_works(self):
        ...
        result = self.sandbox.execute_string("import privacy_test")
        ...
        module_result = self.sandbox.execute_string("privacy_test")
    ...
    def test_struct_import_now_works(self):
        ...
        result = self.sandbox.execute_string("from privacy_test import PublicStruct")
        ...
        struct_result = self.sandbox.execute_string("PublicStruct")
