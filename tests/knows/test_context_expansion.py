...
from opendxa.knows.extraction.context.similarity import (
    SimilaritySearcher, SimilarityResult, SemanticMatch
)
from opendxa.knows.extraction.context.expander import (
    ContextExpander, ContextExpansion, ContextValidation
)
from opendxa.common.resource.llm_resource import BaseRequest, BaseResponse
...
class TestContextExpander:
    ...
    def context_expander(self, mock_llm_resource):
        ...
        return ContextExpander(
            llm_resource=mock_llm_resource,
    ...
    def test_expand_context_with_llm(self, context_expander, sample_knowledge_points):
        ...
        for expansion in expansions:
            ...
            assert expansion.confidence >= context_expander.confidence_threshold
    ...
    def test_create_context_relationships(self, context_expander, sample_knowledge_points):
        ...
        relationships = context_expander._create_context_relationships(
            sample_knowledge_points, expansions
        )
...
class TestPhase3Integration:
    ...
    def test_similarity_and_context_integration(self):
        ...
        similar_pairs = [
            ...
            for match in similarity_result["semantic_matches"]
        ]
