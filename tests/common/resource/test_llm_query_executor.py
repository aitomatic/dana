...
class TestLLMQueryExecutorAnthropicIntegration(unittest.TestCase):
    ...
    def test_anthropic_system_message_transformation_in_query_executor(self, mock_client_class):
        ...
        self.assertEqual(len(system_messages_in_array), 1, 
                        "System messages should remain in messages array for AISuite to handle")
        ...
        self.assertNotIn("system", request_params, 
                        "No manual system parameter should be created to avoid conflicts with AISuite")
    ...
    def test_build_default_request_params_anthropic_system_transformation(self):
        ...
        self.assertEqual(len(system_in_messages), 2, 
                        "System messages should remain in messages array for AISuite")
