...
def test_set_level_module_path():
    ...
    # Create test loggers
    logger1 = logging.getLogger("dana.agent")
...
def test_set_level_submodule():
    ...
    # Create test loggers
    logger1 = logging.getLogger("dana.agent.core")
    logger2 = logging.getLogger("dana.agent.utils")
    ...
    dana_logger = DanaLogger("test")
    dana_logger.setLevel(logging.DEBUG, "dana.agent")
