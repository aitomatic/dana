...
def test_fstring_with_identifier():
    ...
    assert fexpr.parts[1].name == "foo"  # No automatic local: prefix
...
def test_fstring_with_binary_expression():
    ...
    assert bexpr.left.name == "x"  # No automatic local: prefix
    assert isinstance(bexpr.right, Identifier)
    assert bexpr.right.name == "y"  # No automatic local: prefix
...
def test_fstring_starts_with_expression():
    ...
    assert fexpr.parts[0].name == "a"  # No automatic local: prefix
    ...
    assert fexpr2.parts[0].name == "a"  # No automatic local: prefix
