...
class TestStructTypeValidation:
    ...
    def test_type_validation_during_field_assignment(self):
        ...
        fields = [
            StructField(name="x", type_hint=TypeHint(name="int")),
            StructField(name="label", type_hint=TypeHint(name="str"))
        ]
    ...
    def test_list_and_dict_type_validation(self):
        ...
        fields = [
            StructField(name="tags", type_hint=TypeHint(name="list")),
            StructField(name="metadata", type_hint=TypeHint(name="dict"))
        ]
    ...
    def test_nested_struct_type_validation(self):
        ...
        point_fields = [
            StructField(name="x", type_hint=TypeHint(name="int")),
            StructField(name="y", type_hint=TypeHint(name="int"))
        ]
...
class TestStructErrorMessages:
    ...
    def test_type_error_comprehensive_message(self):
        ...
        fields = [
            StructField(name="number", type_hint=TypeHint(name="int")),
            StructField(name="text", type_hint=TypeHint(name="str"))
        ]
        struct_def = StructDefinition(name="TestStruct", fields=fields)
        register_struct_from_ast(struct_def)
