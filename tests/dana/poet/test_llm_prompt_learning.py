...
class TestPromptLearner:
    ...
    def test_prompt_analysis_simulation(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            analysis = learner.analyze_prompt(
                short_prompt, 
                "financial_services", 
                "test_function"
            )
    ...
    def test_prompt_history_persistence(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            learner1.record_execution_feedback(
                "test_function", "test prompt", 0.8, 1.5, True
            )
...
class TestEnhancedLLMOptimizationPlugin:
    ...
    def test_parameter_learning_application(self):
        ...
        learned_params = {
            "response_validation_threshold": 0.8,
            "context_optimization_level": 0.9,
