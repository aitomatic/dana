...
- **test_lambda_with_structs.na** - Lambda expressions with struct receivers and method calls ✅
...
- **test_nested_comprehensions.na** - Nested comprehensions (currently not supported) ⚠️
...
- ⚠️ Nested comprehensions: `[item for row in matrix for item in row]` (not supported)
- ✅ Conditional expressions in comprehensions
- ✅ Complex filtering and transformations
- ⚠️ Function calls in comprehensions (EagerPromise resolution issue)
...
### Current Issues
- **Nested Comprehensions**: `for ... for ...` syntax is not supported in Dana
- **Function Calls in Comprehensions**: EagerPromise objects are not automatically resolved in comprehension results
