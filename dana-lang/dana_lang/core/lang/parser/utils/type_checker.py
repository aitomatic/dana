...
from dana_lang.common.exceptions import TypeError
...
class TypeChecker:
    ...
    def _is_agent_declarative(self, statement: Any) -> bool:
        try:
            from dana_lang.core.lang.ast import AgentDefinition as _AgentDef
            from dana_lang.core.lang.ast import BaseAgentSingletonDefinition as _BaseAgentSingletonDef
            from dana_lang.core.lang.ast import SingletonAgentDefinition as _SingletonAgentDef
    ...
    def check_assignment(self, node: Assignment) -> None:
        ...
        from dana_lang.core.lang.ast import AttributeAccess, Identifier
