...
from dana_lang.core.lang.parser.transformer.dana_transformer import DanaTransformer
from dana_lang.core.lang.parser.utils.metadata_processor import MetadataProcessor
from dana_lang.core.lang.parser.utils.type_checker import TypeChecker, TypeEnvironment
...
class DanaParser(Lark, Loggable):
    ...
    def transform(self, parse_tree: Tree, do_type_check: bool = False) -> Program:
        ...
        if self.current_filename:
            from dana_lang.core.lang.ast import Location
