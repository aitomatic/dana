...
from dana_lang.core.lang.ast import Decorator
...
class DecoratorTransformer:
    ...
    def transform_decorator_from_items(self, items: list[Any]) -> Decorator:
        ...
        from dana_lang.core.lang.parser.transformer.statement.statement_utils import StatementTransformationUtils
