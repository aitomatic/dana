...
from dana_lang.api.client import APIClient
from dana_lang.api.server import APIServiceManager
...
# from frameworks.poet.core.client import POETClient, set_default_client  # Removed for KISS
    ...
    def __init__(
        ...
        try:
            ...
            if not self._interpreter.function_registry.has("len", None):
                ...
                from dana_lang.libs.corelib.py_wrappers.register_py_wrappers import _register_python_functions
