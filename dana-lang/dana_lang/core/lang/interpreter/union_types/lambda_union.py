...
from dana_lang.core.lang.ast import LambdaExpression, TypeHint
from dana_lang.core.lang.sandbox_context import SandboxContext
from dana_lang.core.lang.type_system.constants import COMMON_TYPE_NAMES, PYTHON_TO_DANA_TYPE_MAPPING
from registry import FUNCTION_REGISTRY, TYPE_REGISTRY
...
def enhance_lambda_receiver_with_unions():
    ...
    """
    try:
        from dana_lang.core.lang.interpreter.struct_functions.lambda_receiver import LambdaReceiver
