...
from dana_lang.core.lang.interpreter.executor.function_error_handling import (
    FunctionExecutionErrorHandler,
)
from dana_lang.core.lang.interpreter.executor.function_name_utils import FunctionNameInfo
from dana_lang.core.lang.interpreter.executor.resolver.unified_function_dispatcher import (
...
class FunctionExecutor(BaseExecutor):
    ...
    def execute_function_call(self, node: FunctionCall, context: SandboxContext) -> Any:
        ...
        from dana_lang.core.lang.ast import AttributeAccess
    ...
    def _apply_function_result_coercion(self, result: Any, function_name: str) -> Any:
        ...
        """
        try:
            from dana_lang.core.lang.interpreter.unified_coercion import TypeCoercion
    ...
    def _execute_user_defined_function(self, func_data: dict[str, Any], args: list[Any], context: SandboxContext) -> Any:
        ...
        try:
            ...
            from dana_lang.core.lang.interpreter.executor.control_flow.exceptions import (
                ReturnException,
            )
    ...
    def __check_struct_instantiation(self, node: FunctionCall, context: SandboxContext, evaluated_kwargs: dict[str, Any]) -> Any | None:
        ...
        from dana_lang.core.builtins.struct_system import create_struct_instance
        ...
        if TYPE_REGISTRY.exists(base_name):
            try:
                ...
                from dana_lang.core.concurrency import resolve_if_promise
        ...
        try:
            ...
            try:
                ...
                if func_obj is not None:
                    ...
                    from dana_lang.core.lang.interpreter.functions.dana_function import (
                        DanaFunction,
                    )
    ...
    def _extract_receiver_types(self, receiver_param: Parameter) -> list[str]:
        ...
        for type_name in receiver_types:
            ...
            try:
                from dana_lang.core.resource.resource_registry import ResourceTypeRegistry
