...
from dana_lang.common.exceptions import SandboxError, StateError
...
from dana_lang.core.lang.interpreter.executor.expression.binary_operation_handler import (
    BinaryOperationHandler,
)
from dana_lang.core.lang.interpreter.executor.expression.collection_processor import (
    CollectionProcessor,
)
from dana_lang.core.lang.interpreter.executor.expression.identifier_resolver import (
    IdentifierResolver,
)
from dana_lang.core.lang.interpreter.executor.expression.pipe_operation_handler import (
...
class ExpressionExecutor(BaseExecutor):
    ...
    def execute_subscript_expression(self, node: SubscriptExpression, context: SandboxContext) -> Any:
        ...
        """
        from dana_lang.core.concurrency import is_promise, resolve_promise
        from dana_lang.core.lang.ast import SliceExpression, SliceTuple
    ...
    def _execute_slice_tuple(self, target: Any, slice_tuple: Any, context: SandboxContext) -> Any:
        ...
        """
        from dana_lang.core.lang.ast import SliceExpression
        ...
        if isinstance(stage, FunctionCall):
            ...
            if isinstance(stage, Identifier):
                ...
                if callable(func):
                    ...
                    from dana_lang.core.lang.interpreter.functions.sandbox_function import (
                        SandboxFunction,
                    )
    ...
    def execute_lambda_expression(self, node: LambdaExpression, context: SandboxContext) -> Any:
        ...
        def lambda_function(*args, **kwargs):
            ...
            try:
                from dana_lang.core.lang.type_system.lambda_types import LambdaTypeValidator
