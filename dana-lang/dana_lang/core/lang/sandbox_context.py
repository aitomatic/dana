...
from dana_lang.common.exceptions import StateError
...
from dana_lang.core.lang.parser.utils.scope_utils import extract_scope_and_name
...
class SandboxContext(Loggable):
    ...
    def __init__(self, parent: Optional["SandboxContext"] = None, manager: Optional["ContextManager"] = None, track_execution: bool = True):
        ...
        from dana_lang.core.lang.interpreter.error_context import ErrorContext
