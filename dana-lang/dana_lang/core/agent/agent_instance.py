...
from frameworks.corral import CORRALEngineer
from frameworks.prteng import PromptEngineer
...
class AgentInstance(
    ...
    def prompt_engineer(self):
        ...
        if self._prompt_engineer is None:
            ...
            if llm_res is not None and hasattr(llm_res, "kind") and llm_res.kind == "llm":
                ...
                from dana_lang.core.resource.builtins.llm_resource_type import LLMResourceInstance
    ...
    def context_engineer(self):
        ...
        if self._context_engineer is None:
            from frameworks.ctxeng import ContextEngineer
