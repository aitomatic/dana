...
from dana_lang.core.builtins.struct_system import InterfaceMethodSpec, InterfaceParameterSpec, InterfaceType
...
def create_interface_type_from_ast(interface_def) -> InterfaceType:
    ...
    """
    from dana_lang.core.lang.ast import InterfaceDefinition, InterfaceMethod
