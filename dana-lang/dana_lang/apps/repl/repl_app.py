...
from dana_lang.apps.repl.commands import CommandHandler
from dana_lang.apps.repl.input import InputProcessor
from dana_lang.apps.repl.repl import REPL
from dana_lang.apps.repl.ui import OutputFormatter, PromptSessionManager, WelcomeDisplay
...
from dana_lang.core.runtime import DanaThreadPool
...
async def main(debug: bool = False) -> None:
    ...
    try:
        ...
        if use_fullscreen:
            ...
            from dana_lang.apps.repl.repl import REPL
            from dana_lang.apps.repl.ui.fullscreen_repl import FullScreenREPL
            from dana_lang.common.sys_resource.llm.legacy_llm_resource import LegacyLLMResource
            from dana_lang.common.terminal_utils import ColorScheme
...
class DanaREPLApp(Loggable):
    ...
    def __init__(self, log_level: LogLevel = LogLevel.WARN):
        ...
        from dana_lang.common.terminal_utils import supports_color
