...
from dana_lang.api.repositories import get_background_task_repo
from dana_lang.api.services.intent_detection.intent_handlers.handler_tools.knowledge_ops_tools.generate_knowledge_tool import (
    GenerateKnowledgeTool,
)
from dana_lang.api.core.schemas import ExtractionDataRequest
from dana_lang.api.services.extraction_service import get_extraction_service
from dana_lang.common.utils.misc import Misc
from dana_lang.api.core.database import get_db
from datetime import datetime
import logging
import threading
from dana_lang.common.sys_resource.rag import get_global_rag_resource
import traceback

logger = logging.getLogger(__name__)

# Task type-specific concurrency limits
from dana_lang.api.core.schemas_v2 import BackgroundTaskType
...
class TaskManager:
    ...
    def _load_pending_tasks(self):
        ...
        try:
            for db in get_db():
                ...
                from dana_lang.api.core.schemas_v2 import BackgroundTaskStatus
    ...
    def _process_deep_extract_task(self, task: dict):
        ...
        try:
            ...
            from dana_lang.api.core.schemas import DeepExtractionRequest
    ...
    def _update_task_status(self, task_id: int, status, error: str | None = None):
        ...
        try:
            from dana_lang.api.core.models import BackGroundTask
