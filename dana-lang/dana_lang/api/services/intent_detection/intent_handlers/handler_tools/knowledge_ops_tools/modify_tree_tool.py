...
from dana_lang.api.core.schemas import DomainKnowledgeTree
...
class ModifyTreeTool(BaseTool):
    ...
    def _create_single_node(self, path_parts: list[str], tree_path: str) -> dict:
        ...
        if not self.tree_structure:
            ...
            from dana_lang.api.core.schemas import DomainNode, DomainKnowledgeTree
        ...
        for i in range(start_idx, len(path_parts)):
            ...
            if child_node is None:
                # Create new node
                from dana_lang.api.core.schemas import DomainNode
