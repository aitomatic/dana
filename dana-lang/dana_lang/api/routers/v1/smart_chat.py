...
from dana_lang.api.core.models import Agent, AgentChatHistory
from dana_lang.api.core.schemas import (
    DomainKnowledgeTree,
    IntentDetectionRequest,
    MessageData,
)
from dana_lang.api.services.domain_knowledge_service import (
    get_domain_knowledge_service,
    DomainKnowledgeService,
)
from dana_lang.api.services.intent_detection_service import (
    get_intent_detection_service,
    IntentDetectionService,
)
from dana_lang.api.services.llm_tree_manager import get_llm_tree_manager, LLMTreeManager
from dana_lang.api.services.knowledge_status_manager import KnowledgeStatusManager
from dana_lang.api.routers.v1.agents import clear_agent_cache
...
from dana_lang.api.services.auto_knowledge_generator import get_auto_knowledge_generator
import os
import json
...
async def _get_recent_chat_history(agent_id: int, db: Session, limit: int = 10) -> list[MessageData]:
    ...
    try:
        from dana_lang.api.core.models import AgentChatHistory
    ...
    try:
        ...
        if update_response.success and update_response.updated_tree:
            ...
            if save_success:
                ...
                try:
                    from dana_lang.api.services.domain_knowledge_version_service import get_domain_knowledge_version_service
