...
from dana_lang.api.services.domain_knowledge_service import get_domain_knowledge_service, DomainKnowledgeService
from dana_lang.api.services.intent_detection_service import get_intent_detection_service, IntentDetectionService
import os
import json
...
async def delete_topic_knowledge_content(
    ...
    """
    from dana_lang.api.core.schemas_v2 import DomainKnowledgeTreeV2
    from dana_lang.api.core.models import Agent
    from pathlib import Path
    import shutil
