...
from frameworks.knows.core.context.base import Context, ContextError, ContextSyncError, ContextType
from frameworks.knows.core.context.config import ContextSettings
...
class ContextManager:
    ...
    def sync_contexts(self, source_type: ContextType, target_type: ContextType, keys: list[str] | None = None) -> None:
    ...
    def __repr__(self) -> str:
        ...
        return f"ContextManager(contexts={list(self.contexts.keys())}, cache_size={len(self._cache)}, settings={self.settings})"
